...
<form action="login.php" method="post">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 15px #000; color:Black;"><center>NS Company User</center></font>
		<br>
...
<div class="input-prepend">
	...
	<input type="password" style="height:40px;" name="password" Placeholder="Your Password" required/><br>
		</div>
		<div class="qwe">
