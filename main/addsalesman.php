...
<form action="savesalesman.php" method="post">
<center><h4><i class="icon-plus-sign icon-large"></i> Add Salesman</h4></center>
<hr>
<div id="ac">
<span>Salesman Name: </span><input type="text" style="width:265px; height:30px;" name="name" required/><br>
...
<span>Salary: </span><input type="text" style="width:265px; height:30px;" name="salary" /><br>
