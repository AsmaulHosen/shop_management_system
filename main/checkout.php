...
<input type="text" size="25" value="" name="address" id="address" onblur="fill();" class="" autocomplete="off" placeholder="Enter Address" style="width: 268px; height:30px;" />
<input type="text" size="25" value="" name="contact" id="contact" onblur="fill();" class="" autocomplete="off" placeholder="Enter Contract no" style="width: 268px; height:30px;" />
