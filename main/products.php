...
<script>
function sum() {
            var txtFirstNumberValue = document.getElementById('txt1').value; // sales price
            var txtSecondNumberValue = document.getElementById('txt2').value; // original price
...
function validate(){
        var txtFirstNumberValue = parseInt(document.getElementById('txt1').value); // sales price
        var txtSecondNumberValue = parseInt(document.getElementById('txt2').value); // original price
        if(txtFirstNumberValue < txtSecondNumberValue){
			   alert('orginale price must be same as sales price or below'); 
			   return false;
		}
...
<div class="container-fluid">
	...
	<div class="contentheader">
			<i class="icon-table"></i> NS Products
			</div>
			<ul class="breadcrumb">
...
<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
		<?php
			...
			<td><?php echo $row['pro_band_name']; ?></td>
			...
			<?php if($row['qty'] !=0){ ?>
			<center>
				<a rel="facebox" title="Click to edit the product" href="editproduct.php?id=<?php echo $row['product_id']; ?>&code=<?php echo $row['product_name']; ?>&name=<?php echo $row['pro_band_name'] ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
			...
			<?php }else{ ?>
			 <center><p >Not Available</p>
			 <a href="#" id="<?php echo $row['product_id']; ?>" class="delbutton" title="Click to Delete the product"><button class="btn btn-danger"><i class="icon-trash"></i></button></a></center>
			<?php } ?>
			</td>
