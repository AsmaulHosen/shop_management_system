...
<div class="container-fluid">
	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="sales_inventory.php"><i class="icon-table icon-2x"></i>Inventory</a></li>
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> NS Product Inventory
			</div>
			<ul class="breadcrumb">
...
<br><br><br>
<center><strong>NS Product Inventory</strong></center>
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	<thead>
		<tr>
			<th width="12%"> Invoice No</th>
			<th width="9%"> Sales Date </th>
