...
<div class="container-fluid">
	...
	<div class="span2">
		...
		<br>
			...
			<li class="active"><a href="sales_salesman.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i> Sales</a>  </li>
...
<option></option>
	...
	?>
		<option value="<?php echo $row['product_id'];?>"><?php echo $row['product_name']; ?> -<?php echo $row['pro_band_name']; ?></option>
	<?php
				}
			?>
</select>
